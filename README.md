...
[![GoDoc](https://godoc.org/github.com/iauglov/go-readability?status.png)](https://godoc.org/github.com/iauglov/go-readability)
[![Travis CI](https://travis-ci.org/iauglov/go-readability.svg?branch=master)](https://travis-ci.org/iauglov/go-readability)
[![Go Report Card](https://goreportcard.com/badge/github.com/iauglov/go-readability)](https://goreportcard.com/report/github.com/iauglov/go-readability)
...
```
go get -u -v github.com/iauglov/go-readability
```
...
import (
	...
	readability "github.com/iauglov/go-readability"
)
...
```
go get -u -v github.com/iauglov/go-readability/cmd/...
```
